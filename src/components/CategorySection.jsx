...
//       buttons: ["Women", "Men"],
//       bgImage: "https://optimaxweb.glassesusa.com/image/upload/f_auto,q_auto/mf-homepage/client/mobileImg/popular-glasses-usa_e86b12d8bd8dae5e6e52.jpg",
...
//       buttons: ["Women", "Men"],
//       bgImage: "https://optimaxweb.glassesusa.com/image/upload/f_auto,q_auto/mf-homepage/client/mobileImg/designer-frames-outlet_ba2cd75af450f59eb006.jpg",
//       bgColor: "bg-blue-500"
//     },
//     {
//       id: 3,
...
//       bgImage: "https://optimaxweb.glassesusa.com/image/upload/f_auto,q_auto/mf-homepage/client/mobileImg/glasses-online-with-insurance_f01fbb412985e4ada8c5.jpg",
...
//       bgImage: "https://optimaxweb.glassesusa.com/image/upload/f_auto,q_auto/mf-homepage/client/mobileImg/contact-lenses-online_a8e20e9b9535e1f2cc2a.jpg",
//       bgColor: "bg-cyan-400"
//     }
//   ];
...
//       title: "Eyeglasses",
//       buttons: ["Women", "Men"],
//       bgImage: "https://via.placeholder.com/300x400/E11D48/000000?text=Eyeglasses",
...
//       title: "Sunglasses",
//       buttons: ["Women", "Men"],
//       bgImage: "https://via.placeholder.com/300x400/DC2626/000000?text=Sunglasses",
//       bgColor: "bg-red-600"
//     }
//   ];
...
//                 {category.subtitle && (
//                   <p className="text-sm mb-3 opacity-90">{category.subtitle}</p>
//                 )}
          ...
          {desktopCategories.map((category) => (
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-end p-4 text-white">
                ...
                <div className="flex gap-2 flex-wrap">
                  {category.buttons.map((button, idx) =>
                    category.title === "We Accept Vision Insurance" ? (
                      // 👇 Special case: link to /insurance
                      <Link
                        key={idx}
                        to="/insurance"
                        className="px-4 py-1.5 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-full text-sm font-medium hover:bg-opacity-30 transition-all"
