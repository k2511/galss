...
import Hero2 from "../assets/Hero/hero2.jpg"; // add a 2nd banner image
...
const PromoBanner = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* Main Banner */}
      <div
        className="relative flex items-center justify-end bg-cover bg-center h-[380px] transition-all duration-700"
        style={{
