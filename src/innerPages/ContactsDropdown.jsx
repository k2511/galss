      ...
      <div className="flex-1 min-w-[180px]">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="rounded-xl p-2 border border-gray-200 text-center bg-white col-span-2">
            <Link to="/contacts/shopall" className="block">
