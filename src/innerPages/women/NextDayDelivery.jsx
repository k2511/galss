...
const NextDayDelivery = () => {
  ...
  const topTabs = ["All Glasses", "Premium", "Discounted", "Trending", "RayBan"];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter products with random “next-day delivery” eligibility
        const filtered = transformed.filter(() => Math.random() > 0.3);
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-6">
          Next-Day Delivery ({totalProducts})
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {loading ? (
            ...
            <div className="col-span-full text-center py-8 text-gray-500">
              No products available for next-day delivery.
            </div>
          ) : (
