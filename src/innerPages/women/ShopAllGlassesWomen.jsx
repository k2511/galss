...
// //       {/* Added PromoBanner after header */}
// //       <PromoBanner />
...
//         {/* Filters Bar */}
//         <div className="bg-gray-50 rounded-lg flex h-[200px] flex-wrap justify-between items-center px-4 py-3 mb-8 gap-3">
//           <div className="flex flex-wrap gap-3 relative">
//             {Object.keys(filterData).map((filterKey) => (
//               <div key={filterKey} className="relative">
//                 <button
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-12">
          {products.map((product) => (
            <div key={product.id} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-all group">
              ...
              <div className="p-4 bg-white">
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <span className="text-xs text-green-600 font-medium">incl. lenses</span>
                </div>
