...
const EyeProductName = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center  border-2 border-black px-4 py-10 bg-gray-50 relative ">
      <div className="flex flex-col md:flex-row   justify-center border-2 border-black">
        ...
        <div className="md:w-1/2 mt-8 md:mt-0 md:pl-10 z-0 border-2 border-black">
          ...
          <div className="mt-4 border-2 border-black">
            <div className="flex items-center gap-3 border-2 border-black">
              <span className="text-xl font-bold text-[#00bac6]">
          ...
          <p>
            ...
            category_id
            :{" "}
              <span className="font-medium">{"   "}{item?.category_id}</span>
            </p>
            <p>
            gender
            :{" "}
       ...
       rating
            ...
            :{" "}
              <span className="font-medium">{"   "}{item.matchedReview?.rating
              }</span>
            </p>
          </div>
        </div>
