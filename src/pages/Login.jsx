      ...
      {step == 1 && (
        <div className="w-full lg:w-1/2 flex items-center justify-center mx-auto">
          <div className="max-w-md w-full space-y-6 ">
            ...
            <div className="flex items-center justify-center gap-3 w-full  mx-auto border border-gray-300 rounded-xl py-3 px-5 cursor-pointer hover:bg-gray-100 transition-all shadow-sm hover:shadow-md">
                {/* <img
                  src="https://eshopweb.store/assets/front_end/modern/image/pictures/google-logo-9825.png"
                  alt="Google"
                  className="w-6 h-6"
                /> */}
                <FcGoogle className="sm:text-3xl text-xl" />
                <p className="m-0 sm:text-lg text-sm text-gray-700 font-medium">
